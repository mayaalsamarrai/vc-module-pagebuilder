...
![Diagram](media/screen-page-builder-1.png)
...
![Preview](media/screen-preview-page.png)
1. The system will display the page in Storefront with no possibility to edit the page.
![Preview on storefront](media/screen-preview-on-store.png)
...
![Pagebuilder installed](media/screen-cms-pagebuilder.png)
